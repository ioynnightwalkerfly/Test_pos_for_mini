                ...
                <tr>
                  ...
                  <td>
                    ...
                    <!-- <a href="level.php?ace=edit&l_id=<?php echo $row_level['l_id'];?>" class="btn btn-warning btn-xs"> edit</a> -->
                      ...
                      <!-- ปุ่มลบข้อมูล -->
                    <td>
                      <a href="member_db.php?mem_id=<?php echo $row_member['mem_id']; ?>&&member=del" class="del-btn btn btn-danger">
                      
                          <!-- ข้อความแจ้งเตือนว่าจะลบหรือไม่ -->
                        <i class="fas fa-trash"  onclick="return confirm('ต้องการลบข้อมูลนี้ใช่หรือไม่')"></i> del
                      </a>
                    </td>
                      <!-- ปุ่มลบข้อมูล -->
